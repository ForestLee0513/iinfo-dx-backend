...
서열표 읽기는 공개 API(/web/tables)와 동일한 crud_tables를 재사용하되 어드민 인증 뒤에 둔다.
...
from app.crud import crud_songs, crud_tables
from app.schemas.song import SongDetail, SongListResponse, VersionListResponse
from app.schemas.table import TableDetail, TableListResponse
