...
실제 Supabase 반영은 주간 크롤링 스케줄러(app/services/difficulty_crawl/scheduler.py)로만 이뤄진다.
...
from app.services.difficulty_crawl.crawlers import CRAWLER_REGISTRY, get_crawler
