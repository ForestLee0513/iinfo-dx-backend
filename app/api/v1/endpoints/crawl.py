"""통합 크롤 라우터 (/api/v1/crawl/*) — 곡 마스터 + 난이도표 크롤을 한 곳에서 다룬다.
...
— 리버스 프록시에서 공개 도메인에 대해 POST/GET/PUT/DELETE /crawl/targets/*(GET 목록 제외),
/crawl/jobs*, /crawl/schedules*는 차단해야 한다(README 참고).
"""
...
from app.services.difficulty_crawl.crawlers import CRAWLER_REGISTRY, get_crawler as get_table_crawler
from app.services.songs_crawl.crawlers.base import SONG_CRAWLER_REGISTRY, get_crawler as get_song_crawler
