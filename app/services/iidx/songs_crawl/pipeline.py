...
크롤 대상은 어드민 API(POST /iidx/crawl/targets)로 Redis에 등록된 것을 사용한다(kind="song").
...
from app.services.iidx.songs_crawl.crawlers import textage  # noqa: F401
from app.services.iidx.songs_crawl.crawlers.base import get_crawler
from app.services.iidx.admin import targets as admin_targets
from app.crud.iidx.songs import sync_song_master
