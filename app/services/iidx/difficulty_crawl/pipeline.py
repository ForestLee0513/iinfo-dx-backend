...
from app.services.iidx.difficulty_crawl.crawlers import get_crawler  # import 시 크롤러 레지스트리 등록됨
from app.services.iidx.admin import targets as admin_targets
from app.crud.iidx.difficulty import log_sync_failure, sync_table_result
