...
스케줄은 어드민 대시보드(PUT /iidx/crawl/schedules/{target_key})에서 크롤 대상(song/table
...
스케줄 실행도 어드민 작업 실행기(app.services.iidx.admin.jobs)를 거치므로
...
from app.services.iidx.admin import store as admin_store
from app.services.iidx.admin import targets as admin_targets
from app.core.config import settings
from app.services.iidx.difficulty_crawl.pipeline import run_table_sync
from app.services.iidx.songs_crawl.pipeline import run_song_sync
